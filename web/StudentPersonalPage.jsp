    ...
    <div class="vertical-center sun">
        <div class="container">
            <div class="row">
                <div class="action">
                    <div class="col-sm-12">
                        <h1 class="title">Welcome ${user.ueser.nickname}</h1>
                        <p>现在开始孤独的学习吧！欢迎来到个人中心</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                <div class="single-service">
                    ...
                    <h2><a href="AlertSelf.jsp">修改个人资料</a></h2>
            ...
            <div class="col-sm-3 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                <div class="single-service">
                    ...
                    <h2><a href="ChangeMyPassWord.jsp">修改密码</a></h2>
            ...
            <div class="col-sm-3 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                <div class="single-service">
                    ...
                    <h2><a href="QueryPerformance.jsp">查询成绩</a></h2>
